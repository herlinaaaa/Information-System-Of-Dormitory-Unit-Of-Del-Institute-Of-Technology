...
<head>
    ...
    <title>Antiokhia (Danau Toba)</title>
...
<body>
    ...
    <main>
        <section class="section">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Kamar Antiokhia (Danau Toba)</h5>
                    <a class="btn btn-primary" href="halamankamar" role="button">Kembali</a>
                        ...
                        <tbody>
                            ...
                            @foreach ($data as $data)
                                <tr>
                                    ...
                                    <td>{{ $data->profil->prodi4 }}</td>
                                    <td>{{ $data->profil->akt }}</td>
                                    <td>{{ $data->kamar }}</td>
                                </tr>
                            @endforeach
                        </tbody>
