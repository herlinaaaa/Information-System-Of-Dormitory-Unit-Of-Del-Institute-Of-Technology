        ...
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Dorm Info</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li><a href="#mate">Dorm Mate</a></li>
                            <li><a href="kurveyharian">Jadwal Kurve</a></li>
                            <li><a href="ibadah">Renungan Asrama</a></li>
                            <li><a href="#keterangan">Keterangan IB & IK</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="nav-link scrollto" href="userkritiksaran">Kritik & Saran</a></li>
                    <li><a class="nav-link scrollto" href="{{ route('profile.edit', Auth::id()) }}"><button
                                type="button" class="btn btn-warning">Profil</button></a></li>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in"
                        ...
                        <div class="icon-box iconbox-blue">
                            ...
                            <h4><a href="aturanumum">Aturan Umum</a></h4>
        ...
        <section id="mate" class="cta">
            <div class="container" data-aos="zoom-in">
                <div class="text-center">
                    ...
                    <a class="cta-btn" href="halamankamar">Lihat kamar</a>
                </div>
            </div>
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                            ...
                            <div class="portfolio-info">
                                <div class="portfolio-links">
                                    <a href="images/5.jpeg" data-gallery="portfolioGallery"
                                        class="portfolio-lightbox" title=""><i class="bx bx-plus"></i></a>
                                    <a href="halamanasrama" title="Refreshing"><i class="bx bx-link"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
