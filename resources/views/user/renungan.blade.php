                    ...
                    <table class="table datatable" id="datatable">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Ayat Pagi</th>
                                <th scope="col">Ayat Malam</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($renungans as $data)
                                <tr>
                                    <th scope="row">{{ $no++ }}</th>
                                    <td>{{ $data->date }}</td>
                                    <td>{{ $data->ayatpagi }} atau <a href="{{ $data->linkpagi }}">renungan</a></td>
                                    <td>{{ $data->ayatmalam }} atau <a href="{{ $data->linkpagi }}">renungan</a></td>
