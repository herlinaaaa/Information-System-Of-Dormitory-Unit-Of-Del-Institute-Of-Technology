...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            ...
            Pengeditan data Sakit, mohon diisi dengan teliti dan lengkap!
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Edit Data Sakit</h5>

                            <!-- General Form Elements -->
                            <form action="{{ url('addsakit/' . $model->id) }}" method="POST">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" style="height: 100px" required name="pesan" value="">{{ $model->pesan }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-select" id="validationDefault04" name="penanganan"
                                            required value="{{ $model->penanganan }}">
                                            <option selected disabled value="">Pilih..</option>
                                            <option value="Menunggu"
                                                {{ $model->penanganan == 'Menunggu' ? 'selected' : '' }}>Menunggu
                                            </option>
                                            <option value="Izin"
                                                {{ $model->penanganan == 'Izin' ? 'selected' : '' }}>Diberi izin
                                            </option>
                                            <option value="Ditolak"
                                                {{ $model->penanganan == 'Ditolak' ? 'selected' : '' }}>
                                                Tidak diberi izin</option>
