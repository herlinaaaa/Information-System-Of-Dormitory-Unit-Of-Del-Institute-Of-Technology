...
<body>
    ...
    <main id="main" class="main">
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            ...
            Penambahan dokumen asrama, mohon diisi dengan teliti dan lengkap!
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form action="{{ url('datadok') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    @foreach ($data as $data)
                                        <tr>
                                            <th>{{ $data->name_file }}</th>
                                            <td>{{ $data->created_at }}</td>
                                            <td>{{ $data->file }}</td>
                                            <td>
                                                <a class="btn btn-warning btn-sm"
                                                    href="{{ url('datadok/' . $data->id . '/edit') }}"><i
                                                        class="bi bi-pencil-square"></i></a>
                                                <form action="{{ url('datadok/' . $data->id) }}" method="POST">
                                                    @csrf
