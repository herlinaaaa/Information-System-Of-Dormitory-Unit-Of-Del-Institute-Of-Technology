...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            ...
            Pengeditan data kamar, mohon diisi dengan teliti dan lengkap!
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
        <div class="row">
            <div class="col-lg-2">
                <div class="card text-justify">
                    <a href="../../matedorm" class="btn btn-primary">Tambah Data Kamar</a>
                </div>
            </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ url('matedorm/' . $model->id) }}" method="POST">
                                @csrf
                                @method('PATCH')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="user_nim"
                                            value="{{ $model->user_nim }}">
                                    </div>
                                </div>

                                <div class="row mb-3">
                                    <label for="validationDefault04" class="col-sm-2 col-form-label">Jenis
                                        Kelamin</label>
                                    <div class="col-sm-10">
                                        <select class="form-select" id="validationDefault04" name="gender" required>
                                            <option selected disabled value="">Pilih..</option>
                                            <option value="Perempuan"
                                                {{ $model->gender == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                                            <option value="Laki-laki"
                                                {{ $model->gender == 'Laki-laki' ? 'selected' : '' }}>Laki-laki</option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-select" id="validationDefault04" name="asrama" required>
                                            ...
                                            <option value="Silo" {{ $model->asrama == 'Silo' ? 'selected' : '' }}>
                                                Silo</option>
                                            <option value="Kapernaum"
                                                {{ $model->asrama == 'Kapernaum' ? 'selected' : '' }}>Kapernaum
                                            </option>
                                ...
                                <div class="row mb-3">
                                    <label for="inputText" class="col-sm-2 col-form-label">Nomor Kamar</label>
                                    <div class="col-sm-10">
                                ...
                                <!-- Ubah kode untuk elemen lainnya sesuai dengan perubahan di atas -->
