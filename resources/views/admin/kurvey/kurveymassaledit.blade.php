...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            ...
            Pengeditan data Kurve Massal, mohon diisi dengan teliti dan lengkap!
        ...
        <div class="row">
            <div class="col-lg-2">
                <div class="card text-justify">
                    <a href="../../kurvemassal" class="btn btn-primary">Tambah Data Kurve Massal</a>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Edit Data Kurve Massal Kampus</h5>

                            <!-- General Form Elements -->
                            <form action="{{ url('kurvemassal/' . $model->id) }}" method="POST">
                                @csrf
                                <input type="hidden" name="_method" value="PATCH">
                                <div class="row mb-3">
                                    <label for="inputText" class="col-sm-2 col-form-label">Prodi</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="prodi3"
                                            value="{{ $model->prodi3 }}">
                                    </div>
                                </div>
