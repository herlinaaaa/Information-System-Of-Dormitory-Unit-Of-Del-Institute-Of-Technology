...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            ...
            Pengeditan data Kurve, mohon diisi dengan teliti dan lengkap!
        ...
        <div class="row">
            <div class="col-lg-2">
                <div class="card text-justify">
                    <a href="../../kurvey" class="btn btn-primary">Tambah Data Kurve Harian</a>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Edit Data Kurve Harian Asrama</h5>

                            <!-- General Form Elements -->
                            <form action="{{ url('kurvey/' . $model->id) }}" method="POST">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="nim"
                                            value="{{ $model->profil->nim }}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="name"
                                            value="{{ $model->profil->name }}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="name"
                                            value="{{ $model->profil->prodi4 }}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="kamar"
                                            value="{{ $model->profil->kamar }}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" style="height: 100px" required name="tugas" value="">{{ $model->tugas }}</textarea>
                                    </div>
                                </div>
