...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            ...
            Penambahan data Renungan, mohon diisi dengan teliti dan lengkap! <br>
            Jika memilih untuk memasukkan ayat renungan mohon beri tanda (-) pada renungan link.
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Tambah Data Renungan Ibadah</h5>

                        <!-- General Form Elements -->
                        <form action="{{ url('renungan') }}" method="POST">
                            @csrf
                            ...
                            <div class="row mb-3">
                                <label for="inputPassword" class="col-sm-2 col-form-label">Ayat Pagi</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" style="height: 100px" name="ayatpagi" required></textarea>
                                </div>
                            </div>


                            <div class="row mb-3">
                                <label for="inputPassword" class="col-sm-2 col-form-label">Ayat Malam</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" style="height: 100px" name="ayatmalam" required></textarea>
                                </div>
                            </div>

                            <div class="row mb-3">
                                <label for="inputPassword" class="col-sm-2 col-form-label">Link Renungan</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" style="height: 100px" name="linkpagi"></textarea>
                                </div>
                            </div>
                            ...
                            <tbody>
                                @foreach ($data as $data)
                                    <tr>
                                        <th>{{ $data->date }}</th>
                                        <td>{{ $data->ayatpagi }}</td>
                                        <td>{{ $data->ayatmalam }}</td>
                                        <td>
                                            <a class="btn btn-warning btn-sm"
                                                href="{{ url('renungan/' . $data->id . '/edit') }}"><i
                                                    class="bi bi-pencil-square"></i></a>
                                            <form action="{{ url('renungan/' . $data->id) }}" method="POST">
                                                @csrf
