...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            ...
            Pengeditan data Renungan, mohon diisi dengan teliti dan lengkap!
        ...
        <div class="row">
            <div class="col-lg-2">
                <div class="card text-justify">
                    <a href="../../renungan" class="btn btn-primary">Tambah Data Renungan</a>
                </div>
            </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ url('renungan/' . $model->id) }}" method="POST">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    <label for="inputPassword" class="col-sm-2 col-form-label">Renungan Pagi</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" style="height: 100px" name="ayatpagi" value="" required>{{ $model->ayatpagi }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <label for="inputPassword" class="col-sm-2 col-form-label">Renungan Malam</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" style="height: 100px" name="ayatmalam" value="" required>{{ $model->ayatmalam }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" style="height: 100px" name="ayatpagi">{{ $model->linkpagi }}</textarea>
                                    </div>
                                </div>
